...
def ice_rmo_stat_load_ondemand():
    ...
    def ondemand_stat_load_data():
        ...
        source_file_set = ["Transactions25.csv"]
                           #["Transactions17.csv","Transactions18.csv", "Transactions19.csv","Transactions20.csv",
                           #"Transactions21.csv","Transactions22.csv","Transactions23.csv", "Transactions24.csv"]
                           #"Transactions02.csv","Transactions03.csv", "Transactions04.csv","Transactions05.csv",
