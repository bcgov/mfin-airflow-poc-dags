...
def test_mssql_connection_for_database(database):
    conn_id = 'mssql_conn_finafdbp'  # Replace with your connection ID
...
# Define the DAG
dag = DAG(
    'test_mssql_finafdbp_conn',
    default_args=default_args,
    description='A DAG to test MSSQL connection for FINAFDBP',
...
database_list = ['FIN_SHARED_LANDING_PROD', 'FIN_SHARED_STAGING_PROD', 'FIN_SHARED_DATA_PROD', 'FIN_SHARED_OPS_PROD', 'FIN_SHARED_FREDA_STATIC_PROD','TACS_BI_EXTRACT']
